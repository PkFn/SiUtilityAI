    ...
    public sealed partial class SiNpcSessionComponent : MySessionComponent, IDraw
    {
        ...
        protected override void OnLoad()
        {
            ...
            _chat?.RegisterChatCommand(
                Command,
                HandleCommand,
                "Manage custom Si Utility AI NPCs. /si-npc spawn <webbing> [paratrooper] [enemy] | spawn-enemy [webbing] | list | clear | utility-ai [toggle|on|off|status] | gamelog [toggle|on|off|status] | help",
